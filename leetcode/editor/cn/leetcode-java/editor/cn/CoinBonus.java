...
// 
// operations[i][0] = 1: 代表第一种操作，operations[i][1]代表成员的编号，operations[i][2]代表
//LeetCoin的数量； 
// operations[i][0] = 2: 代表第二种操作，operations[i][1]代表成员的编号，operations[i][2]代表
//LeetCoin的数量； 
...
// 
// Related Topics 树状数组 线段树 数组 👍 59 👎 0

package leetcode.editor.cn;
public class CoinBonus{
    public static void main(String[] args){
        Solution solution = new CoinBonus().new Solution();
    }

...
// 
//
// Related Topics 数组 字符串 前缀和 👍 18 👎 0
...
public class MinimumAmountOfTimeToCollectGarbage {
    public static void main(String[] args) {
        ...
        String[] gg = {"G", "P", "GP", "GG"};
        int[] ta = {2, 4, 3};
        solution.garbageCollection(gg, ta);
    }
    ...
    class Solution {
        public int garbageCollection(String[] garbage, int[] travel) {
            ...
            for (int i = 0; i < garbage.length; i++) {
                ...
                if (garbage[i].contains(String.valueOf('G'))) {
                    GT = i;
                }
                if (garbage[i].contains(String.valueOf('M'))) {
                    MT = i;
                }
                if (garbage[i].contains(String.valueOf('P'))) {
                    PT = i;
                }
            }
